...
public class Cloud extends Character implements CharacterInterface {
	private int currentHp;
	private int maxHp;
	
	public Cloud(int level, WeaponInterface weapon, int strength, int currentHp, int maxHp, boolean berserked, boolean inFrog,
