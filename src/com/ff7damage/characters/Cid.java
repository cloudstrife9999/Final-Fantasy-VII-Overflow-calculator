...
public class Cid extends Character implements CharacterInterface {
	private int currentMp;
	private int maxMp;
	
	public Cid(int level, WeaponInterface weapon, int strength, int currentMp, int maxMp, boolean berserked, boolean inFrog,
