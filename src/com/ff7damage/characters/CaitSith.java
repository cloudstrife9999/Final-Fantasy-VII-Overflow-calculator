...
public class CaitSith extends Character implements CharacterInterface {
	private int currentHp;
	private int maxHp;
	
	public CaitSith(int level, WeaponInterface weapon, int strength, int currentHp, int maxHp, boolean berserked, boolean inFrog,
