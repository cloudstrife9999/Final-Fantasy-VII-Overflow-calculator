...
public class Yuffie extends Character implements CharacterInterface {

	public Yuffie(int level, WeaponInterface weapon, int strength, boolean berserked, boolean inFrog, boolean inMini, Row row) {
