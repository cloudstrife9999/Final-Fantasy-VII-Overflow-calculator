...
public class Barret extends Character implements CharacterInterface {
	public Barret(int level, WeaponInterface weapon, int strength, boolean berserked, boolean inFrog, boolean inMini, Row row) {
	...
	public int getWeaponAP() {
		return getWeapon().getAp();
	}
	
	@Override
	public String toString() {
		return "Barret Wallace";
	}
